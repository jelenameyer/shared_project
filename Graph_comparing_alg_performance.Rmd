...
plot(x, y, type = "l",ylim = c(40,120), col = "red", xlab = "Percentage of missing data", ylab = "Accuracy of predictions",
main = "Algorithm prediction performance with rising percentages of missings")
lines(x, y_log_reg_multiple_imp, col = "orange")
lines(x, y_log_reg_mean_imp, col = "green")
#lines(x, handle_NA_costs, col = "orange")

# Add a legend to the graph:
legend("topright", legend = c("FFTrees", "multiple imputation", "median imputation"), col = c("red", "orange", "green"), lty = 1)
