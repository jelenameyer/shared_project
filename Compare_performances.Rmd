...
key_results[2, "mn_hi"]  <- mean(heart_NA_25$hi[-1])/n*100
key_results[2, "mn_fa"] <- mean(heart_NA_25$fa[-1])/n*100
key_results[2, "mn_mi"]  <- mean(heart_NA_25$mi[-1])/n*100
key_results[2, "mn_cr"]  <- mean(heart_NA_25$cr[-1])/n*100
