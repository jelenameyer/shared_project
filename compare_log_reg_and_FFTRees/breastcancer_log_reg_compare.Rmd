...
# fitting data
data_subset_cca <- select(data_fit, nucleoli, nuclei.bare, thickness, cellshape.unif, diagnosis)

# prediction data
data_subset_cca_predict <- select(data_predict, nucleoli, nuclei.bare, thickness, cellshape.unif, diagnosis)
