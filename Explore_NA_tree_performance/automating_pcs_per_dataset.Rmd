...
# plot graph:
plot(pcs, all_intersection_points_IDK_1_FFT_handle_titanic , type='o',lty=2 ,col='darkgreen', ylim = c(-5,5),lwd=1,  xlab="Percentage of missing data", ylab="Costs of false decisions", main = "When x more expensive, one_IDK starts performing better than FFT_handle.")
...
# plot graph:
plot(pcs, all_intersection_points_IDK_all_FFT_handle_titanic , type='o',lty=2, ylim = c(-30,30),col='darkgreen',lwd=1,  xlab="Percentage of missing data", ylab="Costs of false decisions",  main = "When x more expensive all_IDK starts performing better than FFT_handle.")
