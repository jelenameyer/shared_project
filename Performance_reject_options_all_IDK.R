...
# define the new percentages of hi, fa, mi, cr and IDK ----
...
n1_pc_goneonly <- n - (n * pc)
hit_1 <- HIT_1_pc * n1_pc_goneonly
fa_1 <- FA_1_pc * n1_pc_goneonly
mi_1 <- MI_1_pc * n1_pc_goneonly
cr_1 <- CR_1_pc * n1_pc_goneonly


# second node:
n1 <- n1_pc_goneonly -(sum(hit_1, fa_1, mi_1, cr_1))
IDK_2<- n1 * pc
...
# new hi, fa, mi, cr values without excluded missings:
n2_pc_goneonly <- n1 - (n1 * pc)
hit_2 <- HIT_2_pc * n2_pc_goneonly
fa_2 <- FA_2_pc * n2_pc_goneonly
mi_2 <- MI_2_pc * n2_pc_goneonly
cr_2 <- CR_2_pc * n2_pc_goneonly

# third node:
n2 <- n2_pc_goneonly -(sum(hit_2, fa_2, mi_2, cr_2))
IDK_3<- n2 * pc
...
IDK_otherwise_unassigned <- sum(IDK_1, IDK_2, IDK_3) - sum(IDK_hit, IDK_mi, IDK_fa, IDK_cr)

# collect in vector:
values <- c(hit, IDK_hit, IDK_mi, mi, fa, IDK_fa, IDK_cr, cr, 0, IDK_otherwise_unassigned, 0, 0)
