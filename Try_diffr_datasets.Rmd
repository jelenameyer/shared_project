...
```{r baseline}
# build example tree with titanic: ----
...
x_summary <- summary(titanic.fft)
x_level_stats <- titanic.fft$trees$level_stats$train
...
key_results[1, "mn_hi"]  <- mean(titanic_NA_25$hi[-1])
key_results[1, "mn_fa"] <- mean(titanic_NA_25$fa[-1])
key_results[1, "mn_mi"]  <- mean(titanic_NA_25$mi[-1])
key_results[1, "mn_cr"]  <- mean(titanic_NA_25$cr[-1])


# Row : in pc:
key_results[2, "pc_NA"]   <- 25
key_results[2, "mn_hi"]  <- mean(titanic_NA_25$hi[-1])/n*100
key_results[2, "mn_fa"] <- mean(titanic_NA_25$fa[-1])/n*100
key_results[2, "mn_mi"]  <- mean(titanic_NA_25$mi[-1])/n*100
key_results[2, "mn_cr"]  <- mean(titanic_NA_25$cr[-1])/n*100
