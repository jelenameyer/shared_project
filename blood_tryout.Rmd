...
heart_fit_indices <- sample(nrow(breastcancer), 0.5 * nrow(breastcancer), replace = FALSE)
heart_fit <- breastcancer[heart_fit_indices,]
nrow(heart_fit)


# find remaining rows and put into predicting df
heart_predict_indices <- setdiff(1:nrow(breastcancer), heart_fit_indices)
heart_predict <- breastcancer[heart_predict_indices,]
nrow(heart_predict)
