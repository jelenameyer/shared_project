...
# 1. Imputation
imp.data <- mice (data = heart_NA_20, m = pc_times_100, maxit = 10, seed = 123, print=FALSE)
...
predictions <- lapply(1:pc_times_100, function(m) {
...
avg_predictions <- Reduce("+", predictions) / pc_times_100
