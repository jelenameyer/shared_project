...
# build table, cost of hi, mi, cr, fa = 1 and x, IDK = 0: ----
```{r table-all-x-IDK-0}
# Define x: ----
...
# Plot the graph with multiple y variables: ----
plot(x, IDK_1, type = "l",ylim = c(0,1), col = "red", xlab = "Costs of IDK", ylab = "Performance")
lines(x, IDK_all, col = "green")
abline(h=original,col="purple",lty=1)
abline(h=FFT_handle,col="blue",lty=1)
...
# Plot the graph with multiple y variables: ----
plot(x, IDK_1, type = "l",ylim = c(0,2), col = "red", xlab = "Costs of IDK", ylab = "Performance")
lines(x, IDK_all, col = "green")
abline(h=original,col="purple",lty=1)
abline(h=FFT_handle,col="blue",lty=1)
...
# Plot the graph with multiple y variables: ----
plot(x, IDK_1, type = "l",ylim = c(0,4), col = "red", xlab = "Costs of IDK", ylab = "Performance")
lines(x, IDK_all, col = "green")
abline(h=original,col="purple",lty=1)
abline(h=FFT_handle,col="blue",lty=1)
...
# testen mit correct normalized data:
(save_performance_1_x - save_performance_1_x[3]) / (save_performance_1_x[2]- (save_performance_1_x[3])) # stimmt nicht ganz
(save_performance_2_x -save_performance_2_x[3]) / (save_performance_2_x[2]-save_performance_2_x[3]) 
(save_performance_4_x -save_performance_4_x[3]) / (save_performance_4_x[2] - save_performance_4_x[3]) 
...
(save_performance_4and8_x -save_performance_4and8_x[3]) / (-save_performance_4and8_x[2]-save_performance_4and8_x[3])
