...
plot(x, original_costs, type = "l",ylim = c(-2,2), col = "red", xlab = "costs false decisions (x * correct decisions)", ylab = "Total costs",
main =paste0("Costs dep. on the rel. costs of false to correct decisions. Missing pc:", pc))
...
# build example tree with data set: ----
# define individually per data set!!!
fertility.fft <- FFTrees(formula = diagnosis ~ .,
                     data = fertility,
                     main = "fertility",
                     goal = "acc", 
                     goal.chase = "acc",
...
# define variables for further use:
# define summary statistic:
x_summary <- summary(fertility.fft)
...
dfs <- loop_datasets(several_data = list(fertility),
                      data_names = c("fertility"), 
                      several_criterion = c("diagnosis"),
                      several_pcs = c(pcs))
...
# Initialize an empty vector to store the intersection points
  all_intersection_points_IDK_1_FFT_handle_fertility <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  one_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_1_FFT_handle_fertility[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_1_FFT_handle_fertility
```
...
```{r Intersection-FFT-handle-all-IDk}
# Initialize an empty vector to store the intersection points:
  all_intersection_points_IDK_all_FFT_handle_fertility <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  all_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_all_FFT_handle_fertility[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_all_FFT_handle_fertility
...
# build example tree with data set: ----
# define individually per data set!!!
contraceptive.fft <- FFTrees(formula = cont.crit ~ .,
                     data = contraceptive,
                     main = "contraceptive",
                     goal = "acc", 
                     goal.chase = "acc",
...
# define variables for further use:
# define summary statistic:
x_summary <- summary(contraceptive.fft)
...
dfs <- loop_datasets(several_data = list(contraceptive),
                      data_names = c("contraceptive"), 
                      several_criterion = c("cont.crit"),
                      several_pcs = c(pcs))
...
# Initialize an empty vector to store the intersection points
  all_intersection_points_IDK_1_FFT_handle_contraceptive <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  one_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_1_FFT_handle_contraceptive[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_1_FFT_handle_contraceptive
```
...
```{r Intersection-FFT-handle-all-IDk}
# Initialize an empty vector to store the intersection points:
  all_intersection_points_IDK_all_FFT_handle_contraceptive <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  all_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_all_FFT_handle_contraceptive[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_all_FFT_handle_contraceptive
...
# build example tree with data set: ----
# define individually per data set!!!
iris.v.fft <- FFTrees(formula = virginica ~ .,
                     data = iris.v,
                     main = "iris.v",
                     goal = "acc", 
                     goal.chase = "acc",
...
dfs <- loop_datasets(several_data = list(iris.v),
                      data_names = c("iris.v"), 
                      several_criterion = c("virginica"),
                      several_pcs = c(pcs))
...
# Initialize an empty vector to store the intersection points
  all_intersection_points_IDK_1_FFT_handle_iris.v <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  one_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_1_FFT_handle_iris.v[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_1_FFT_handle_iris.v
```
...
```{r Intersection-FFT-handle-all-IDk}
# Initialize an empty vector to store the intersection points:
  all_intersection_points_IDK_all_FFT_handle_iris.v <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  all_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_all_FFT_handle_iris.v[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_all_FFT_handle_iris.v
...
# define variables for further use:
# define summary statistic:
x_summary <- summary(mushrooms.fft)
...
dfs <- loop_datasets(several_data = list(mushrooms),
                      data_names = c("mushrooms"), 
                      several_criterion = c("poisonous"),
                      several_pcs = c(pcs))
...
# Initialize an empty vector to store the intersection points
  all_intersection_points_IDK_1_FFT_handle_mushrooms <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  one_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_1_FFT_handle_mushrooms[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_1_FFT_handle_mushrooms
```
...
```{r Intersection-FFT-handle-all-IDk}
# Initialize an empty vector to store the intersection points:
  all_intersection_points_IDK_all_FFT_handle_mushrooms <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  all_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_all_FFT_handle_mushrooms[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_all_FFT_handle_mushrooms
...
dfs <- loop_datasets(several_data = list(sonar),
                      data_names = c("sonar"), 
                      several_criterion = c("mine.crit"),
                      several_pcs = c(pcs))
...
# Initialize an empty vector to store the intersection points
  all_intersection_points_IDK_1_FFT_handle_sonar <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  one_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_1_FFT_handle_sonar[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_1_FFT_handle_sonar
```
...
```{r Intersection-FFT-handle-all-IDk}
# Initialize an empty vector to store the intersection points:
  all_intersection_points_IDK_all_FFT_handle_sonar <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  all_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_all_FFT_handle_sonar[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_all_FFT_handle_sonar
...
# build example tree with data set: ----
# define individually per data set!!!
voting.fft <- FFTrees(formula = party.crit ~ .,
                     data = voting,
                     main = "voting",
                     goal = "acc", 
                     goal.chase = "acc",
...
dfs <- loop_datasets(several_data = list(voting),
                      data_names = c("voting"), 
                      several_criterion = c("party.crit"),
                      several_pcs = c(pcs))
...
# Initialize an empty vector to store the intersection points
  all_intersection_points_IDK_1_FFT_handle_voting <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  one_IDK(x, pc)  - FFT_handle(x), interval = c(-10000, 10000))
all_intersection_points_IDK_1_FFT_handle_voting[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_1_FFT_handle_voting
```
...
```{r Intersection-FFT-handle-all-IDk}
# Initialize an empty vector to store the intersection points:
  all_intersection_points_IDK_all_FFT_handle_voting <- numeric(length(pcs))
...
# Find the intersection point: ----
intersection_point_IDK_1_FFT_handle <- uniroot(function(x)  all_IDK(x, pc)  - FFT_handle(x), interval = c(-1000, 1000))
all_intersection_points_IDK_all_FFT_handle_voting[l] <- intersection_point_IDK_1_FFT_handle$root
}
# Print the intersection point:
all_intersection_points_IDK_all_FFT_handle_voting
...
# iris.v and voting data behaves weirdly.
```{r compare-1-IDK-FFT-handle-false-decision-is-x-2}

# plot graph:
plot(pcs, all_intersection_points_IDK_1_FFT_handle_titanic , type='o',lty=2 ,col='darkgreen', ylim = c(-10,15),lwd=1,  xlab="Percentage of missing data", ylab="Costs of false decisions", main = "When x more expensive, one_IDK better than FFT_handle.")
...
lines(pcs, all_intersection_points_IDK_1_FFT_handle_fertility, type = 'o', lty = 2, col = 'dark red', lwd = 1)
lines(pcs, all_intersection_points_IDK_1_FFT_handle_contraceptive, type = 'o', lty = 2, col = 'green', lwd = 1)
lines(pcs, all_intersection_points_IDK_1_FFT_handle_iris.v, type = 'o', lty = 2, col = 'orange', lwd = 1)
lines(pcs, all_intersection_points_IDK_1_FFT_handle_mushrooms, type = 'o', lty = 2, col = 'yellow', lwd = 1)
lines(pcs, all_intersection_points_IDK_1_FFT_handle_sonar, type = 'o', lty = 2, col = 'pink', lwd = 1)
lines(pcs, all_intersection_points_IDK_1_FFT_handle_voting, type = 'o', lty = 2, col = 'brown', lwd = 1)

# Add a vertical line at 0 using the abline function:
abline(h = 0, col = 'red', lty = 2)

# Add a legend to the graph:
legend("topright", legend = c("titanic data", "heartdisease data", "breastcancer data", "fertility data", "contraceptive data", "iris.v data", "mushroom data", "sonar data", "voting data"), col = c("darkgreen", "blue", "purple", "dark red", "green", "orange", "yellow", "pink", "brown"), lty = 2)
...
# plot graph:
plot(pcs, all_intersection_points_IDK_all_FFT_handle_titanic , type='o',lty=2, ylim = c(-30,30),col='darkgreen',lwd=1,  xlab="Percentage of missing data", ylab="Costs of false decisions",  main = "When x more expensive, all_IDK better than FFT_handle.")
...
lines(pcs, all_intersection_points_IDK_all_FFT_handle_fertility, type = 'o', lty = 2, col = 'dark red', lwd = 1)
lines(pcs, all_intersection_points_IDK_all_FFT_handle_contraceptive, type = 'o', lty = 2, col = 'green', lwd = 1)
lines(pcs, all_intersection_points_IDK_all_FFT_handle_iris.v, type = 'o', lty = 2, col = 'orange', lwd = 1)
lines(pcs, all_intersection_points_IDK_all_FFT_handle_mushrooms, type = 'o', lty = 2, col = 'yellow', lwd = 1)
lines(pcs, all_intersection_points_IDK_all_FFT_handle_sonar, type = 'o', lty = 2, col = 'pink', lwd = 1)
lines(pcs, all_intersection_points_IDK_all_FFT_handle_voting, type = 'o', lty = 2, col = 'brown', lwd = 1)
